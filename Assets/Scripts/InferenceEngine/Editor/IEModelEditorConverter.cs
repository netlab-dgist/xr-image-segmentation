...
{
    private const string FILEPATH = "Assets/Resources/Model/yolo11n-seg-sentis.sentis";
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("Generate YOLOv11 Sentis model with Non-Max-Supression layer"))
        {
